...
for dataset_name in "gsm8k" "math500" "mbpp" "humaneval" "acp_app_bool" "acp_app_gen"; do
python scripts/regenerate_train_data.py \
    ...
    --temperature 0 \
    --input-file-path ./cache/test_dataset/${dataset_name}.jsonl \
    --output-file-path ./cache/test_dataset/${dataset_name}${output_suffix} \
    ${NO_THINK_ARG}
done
